...
<div class="navbar">
	...
	<nav class:open={isMenuOpen}>
		<ul>
			<li>
				<a on:click={() => closeMenu(0)} class:current={current === 0} href="/">Home</a>
			</li>
			<li>
				<a
					on:click={() => closeMenu(1)}
					class:current={current === 1}
					href="/teams"
					data-svelte-prefetch>Teams</a
				>
			</li>
			<li>
				<a on:click={() => closeMenu(2)} class:current={current === 2} href="/games">Games</a>
			</li>
			<!-- <li>
				<a on:click={() => closeMenu(3)} class:current={current === 3} href="/about">About</a>
			</li> -->
